...
public class HighscoreRestController {
     ...
     * The great thing about Spring is that it automatically creates an instance of HighscoreService.
     * This means that we don't have to create an instance of HighscoreService ourselves.
     * @param highscoreService This is the class which contains the methods for handling HTTP requests.
     */
    @Autowired
