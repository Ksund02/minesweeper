...
public class HighscoreRestController {
    ...
    /**
     * Constructor for HighscoreRestController, which is used to handle HTTP
     * requests.
     * The great thing about Spring is that it automatically creates an instance of
     * HighscoreService.
     * This means that we don't have to create an instance of HighscoreService
     * ourselves.
     * 
     * @param highscoreService This is the class which contains the methods for
    ...
    /**
     * This method is used to handle POST requests to the /highscores endpoint.
     * Spring Boot is super smart, and automatically converts the JSON string
     * (which is sent in the request body) to a UserScore object.
     * 
     ...
     * It deletes all the highscores from the highscore file.
     */
